...
当网站流量很小时，只需一个应用，将所有功能都部署在一起，以减少部署节点和成本。此时，用于简化增删改查工作量的数据访问框架(ORM)是影响项目开发的关键。
 ...
 ![1525529091749](/static/assets/1525529091749.png)
...
当访问量逐渐增大，单一应用无法满足需求，此时为了应对更高的并发和业务需求，我们根据业务功能对系统进行拆分：
 ...
 ![1525529671801](/static/assets/1525529671801.png)
...
当垂直应用越来越多，应用之间交互不可避免，将核心业务抽取出来，作为独立的服务，逐渐形成稳定的服务中心，使前端应用能更快速的响应多变的市场需求。此时，用于提高业务复用及整合的分布式调用是关键。
 ...
 ![1525530657919](/static/assets/1525530657919.png)
...
![1525530804753](/static/assets/1525530804753.png)
...
![1525532344817](/static/assets/1525532344817.png)
...
![1526860071166](/static/assets/1526860071166.png)
...
![1525568965976](/static/assets/1525568965976.png)
...
![1525569352313](/static/assets/1525569352313.png)
...
![1525570921966](/static/assets/1525570921966.png)
...
![1526877496885](/static/assets/1526877496885.png)
...
![1526877647406](/static/assets/1526877647406.png)
...
![1526877995530](/static/assets/1526877995530.png)
...
结果：
 ...
 ![1526877988488](/static/assets/1526877988488.png)
...
![1525573702492](/static/assets/1525573702492.png)
...
![1525575656796](/static/assets/1525575656796.png)

## 4.2.版本

SpringCloud的版本命名比较特殊，因为它不是一个组件，而是许多组件的集合，它的命名是以A到Z的为首字母的一些单词组成：

 ![1525575903675](/static/assets/1525575903675.png)
...
![1525576816916](/static/assets/1525576816916.png)

填写项目信息：

 ![1525576909381](/static/assets/1525576909381.png)

添加web依赖：

![1525576950842](/static/assets/1525576950842.png)

添加mybatis依赖：

![1525576999052](/static/assets/1525576999052.png)

填写项目位置：

![1525577029150](/static/assets/1525577029150.png)

生成的项目结构：

 ![1525577106711](/static/assets/1525577106711.png)
...
项目结构：
 ...
 ![1525577911331](/static/assets/1525577911331.png)

### 5.1.3.启动并测试：

启动项目，访问接口：http://localhost:8081/user/7

 ![1525593139364](/static/assets/1525593139364.png)
...
因为我们没有配置端口，那么默认就是8080，我们访问：http://localhost:8080/consume?ids=6,7,8
 ...
 ![1525594222408](/static/assets/1525594222408.png)
...
![1525595012668](/static/assets/1525595012668.png)
...
> 基本架构：
 ...
 ![1525597885059](/static/assets/1525597885059.png)
...
![1525598231170](/static/assets/1525598231170.png)

选择依赖：

![1525598312368](/static/assets/1525598312368.png)
...
![1525604959508](/static/assets/1525604959508.png)

![1525605081129](/static/assets/1525605081129.png)
...
![1525609225152](/static/assets/1525609225152.png)
...
![1525613025086](/static/assets/1525613025086.png)

生成的URL：

![1525613051210](/static/assets/1525613051210.png)

访问结果：

 ![1525613160920](/static/assets/1525613160920.png)
...
注意：idea中一个应用不能启动两次，我们需要重新配置一个启动器：
 ...
 ![1525615070033](/static/assets/1525615070033.png)

 ![1525615095693](/static/assets/1525615095693.png)

![1525615026937](/static/assets/1525615026937.png)

然后启动即可。

3）启动测试：

![1525615165157](/static/assets/1525615165157.png)
...
![1525617060656](/static/assets/1525617060656.png)
...
![1525617542081](/static/assets/1525617542081.png)
...
![1525618396076](/static/assets/1525618396076.png)
...
![1525619257397](/static/assets/1525619257397.png)
...
首先我们启动两个user-service实例，一个8081，一个8082。
 ...
 ![1525619515586](/static/assets/1525619515586.png)

Eureka监控面板：

![1525619546904](/static/assets/1525619546904.png)
...
访问页面，查看结果：
 ...
 ![1525620305704](/static/assets/1525620305704.png)
...
![1525620483637](/static/assets/1525620483637.png)

继续跟入execute方法：发现获取了8082端口的服务

![1525620787090](/static/assets/1525620787090.png)

再跟下一次，发现获取的是8081：

 ![1525620835911](/static/assets/1525620835911.png)
...
编写测试类，在刚才的源码中我们看到拦截中是使用RibbonLoadBalanceClient来进行负载均衡的，其中有一个choose方法，是这样介绍的：
 ...
 ![1525622320277](/static/assets/1525622320277.png)
...
结果：
 ...
 ![1525622357371](/static/assets/1525622357371.png)
...
继续跟踪源码，发现这么一段代码：
 ...
 ![1525622652849](/static/assets/1525622652849.png)

我们看看这个rule是谁：

 ![1525622699666](/static/assets/1525622699666.png)

这里的rule默认值是一个`RoundRobinRule`，看类的介绍：

 ![1525622754316](/static/assets/1525622754316.png)

这不就是轮询的意思嘛。

我们注意到，这个类其实是实现了接口IRule的，查看一下：

 ![1525622817451](/static/assets/1525622817451.png)

定义负载均衡的规则接口。

它有以下实现：

 ![1525622876842](/static/assets/1525622876842.png)
...
再次测试，发现结果变成了随机：
 ...
 ![1525623193949](/static/assets/1525623193949.png)
...
我们现在关闭一个user-service实例：
 ...
 ![1525653565855](/static/assets/1525653565855.png)

因为服务剔除的延迟，consumer并不会立即得到最新的服务列表，此时再次访问你会得到错误提示：

![1525653715488](/static/assets/1525653715488.png)
...
我们重启user-consumer-demo，测试，发现即使user-service2宕机，也能通过另一台服务实例获取到结果！
 ...
 ![1525658269456](/static/assets/1525658269456.png)
