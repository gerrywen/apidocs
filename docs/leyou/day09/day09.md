...
![1526085541996](/static/assets/1526085541996.png)
...
似乎并不复杂，但是大家仔细思考一下，商品的规格字段你如何填写？
 ...
 ![1526086539789](/static/assets/1526086539789.png)
...
> 华为的规格：
 ...
 ![1526087063700](/static/assets/1526087063700.png)



> 三星的规格：

 ![1526087142454](/static/assets/1526087142454.png)
...
如下图所示：
 ...
 ![1526088168565](/static/assets/1526088168565.png)
...
![1526088981953](/static/assets/1526088981953.png)
...
![1526089506566](/static/assets/1526089506566.png)
...
![1526090072535](/static/assets/1526090072535.png)

你会发现，过滤条件中的屏幕尺寸、运行内存、网路、机身内存、电池容量、CPU核数等，在规格参数中都能找到：

 ![1526090228171](/static/assets/1526090228171.png)
...
也就是说，规格参数中的数据，将来会有一部分作为搜索条件来使用。我们可以在设计时，将这部分属性标记出来，将来做搜索的时候，作为过滤条件。要注意的是，无论是SPU的全局属性，还是SKU的特有属性，都有可能作为搜索过滤条件的，并不冲突，而是有一个交集：
 ...
 ![1526091216124](/static/assets/1526091216124.png)
...
![1526092179381](/static/assets/1526092179381.png)
...
> 先整体看一下：
 ...
 ![1526092693138](/static/assets/1526092693138.png)
...
> 接下来是params：
 ...
 ![1526093111370](/static/assets/1526093111370.png)
...
上面的截图中所有属性都是全局属性，我们来看看内存，应该是特有属性：
  ...
  ![1526262641446](/static/assets/1526262641446.png)
...
![1526095296462](/static/assets/1526095296462.png)

因为规格是跟商品分类绑定的，因此首先会展现商品分类树，并且提示你要选择商品分类，才能看到规格参数的模板。一起了解下页面的实现：

![1526095548672](/static/assets/1526095548672.png)
...
接下来，看看Vue实例中data定义了哪些属性，对页面会产生怎样的影响：
 ...
 ![1526287774316](/static/assets/1526287774316.png)
...
当我们点击树节点时，要将`v-dialog`打开，因此必须绑定一个点击事件：
 ...
 ![1526095959539](/static/assets/1526095959539.png)
...
- 返回结果：页面是直接把`resp.data`赋值给了specifications：
  ...
  ![1526104087329](/static/assets/1526104087329.png)
...
目前，我们数据库只提供了3条规格参数信息：
 ...
 ![1526104551227](/static/assets/1526104551227.png)

我们访问：http://api.leyou.com/api/item/spec/76

 ![1526104475036](/static/assets/1526104475036.png)

然后在后台系统中测试：

![1526104599452](/static/assets/1526104599452.png)



当我们点击一个还不存在的规格参数的商品分类：

![1526104769276](/static/assets/1526104769276.png)
...
> 整体来看：
 ...
 ![1526262279963](/static/assets/1526262279963.png)

整体看上去与规格参数表中的数据一样，也是一个数组，并且分组，每组下有多个参数

> 展开一组来看

 ![1526262389233](/static/assets/1526262389233.png)
...
刚才看到的是全局属性，那么特有属性在这个字段中如何存储呢？
 ...
 ![1526263214087](/static/assets/1526263214087.png)
...
在哪里会用到这个字段的值呢，商品详情页的规格参数信息中：
 ...
 ![1526267700765](/static/assets/1526267700765.png)
...
来看数据格式：
 ...
 ![1526267952827](/static/assets/1526267952827.png)
...
比如，商品详情页展示可选的规格参数时：
   ...
   ![1526267828817](/static/assets/1526267828817.png)
...
既然如此，我们是不是可以将不同角标串联起来，作为SPU下不同SKU的标示。这就是我们的indexes字段。
 ...
 ![1526266901335](/static/assets/1526266901335.png)

这个设计在商品详情页会特别有用：

 ![1526267180997](/static/assets/1526267180997.png)
...
![1527823423289](/static/assets/1527823423289.png)
...
![1526268595873](/static/assets/1526268595873.png)
...
模板代码在分别在Goods.vue
 ...
 ![1526269215532](/static/assets/1526269215532.png)

## 4.2.从0开始

接下来，我们自己来实现一下，新建两个组件：MyGoods.vue和MyGoodsForm.vue

 ![1526269362233](/static/assets/1526269362233.png)
...
然后修改menu.js,新建一个菜单：
 ...
 ![1526269555118](/static/assets/1526269555118.png)

修改router/index.js，添加一个路由：

 ![1526269615639](/static/assets/1526269615639.png)

预览一下：

 ![1526269739468](/static/assets/1526269739468.png)
...
![1526272476614](/static/assets/1526272476614.png)
...
![1526272537552](/static/assets/1526272537552.png)
...
另外，似乎页面少了对上下架商品的过滤，在原始效果图中是有的：
 ...
 ![1526277614649](/static/assets/1526277614649.png)

这在Vuetify中是一组按钮，我们查看帮助文档：

 ![1526277713391](/static/assets/1526277713391.png)
...
刷新页面，查看效果：
 ...
 ![1526280777975](/static/assets/1526280777975.png)
...
不过弹窗中没有任何数据：
 ...
 ![1526281134046](/static/assets/1526281134046.png)
...
![1526281659782](/static/assets/1526281659782.png)

其基本结构如图：

![1526282309386](/static/assets/1526282309386.png)
...
![1526283729193](/static/assets/1526283729193.png)
...
![1526283971416](/static/assets/1526283971416.png)
...
改造MyGoods的对话框组件：
  ...
  ![1526285123845](/static/assets/1526285123845.png)

查看页面：

![1526285086042](/static/assets/1526285086042.png)
...
我们先在父组件定义一个step属性：
 ...
 ![1526285364638](/static/assets/1526285364638.png)
...
子组件中接收属性：
 ...
 ![1526285994382](/static/assets/1526285994382.png)

测试效果：

 ![](/static/assets/10.gif)
...
效果：
 ...
 ![1526290196168](/static/assets/1526290196168.png)

查看goods的属性，三级类目都在：

 ![1526290263252](/static/assets/1526290263252.png)
...
品牌不分级别，使用普通下拉选框即可。我们查看官方文档的下拉选框说明：
 ...
 ![1526287929674](/static/assets/1526287929674.png)
...
我们定义一个属性，保存品牌的待选项信息：
 ...
 ![1526289926110](/static/assets/1526289926110.png)
...
#### 测试效果
 ...
 ![1526290461916](/static/assets/1526290461916.png)
...
![1526290761721](/static/assets/1526290761721.png)
...
![1526290914491](/static/assets/1526290914491.png)
...
![1526291232678](/static/assets/1526291232678.png)
...
不过这个组件有个小问题，就是图片上传的无法直接上传到后台，因此我们对其进行了封装，支持了图片的上传。
 ...
 ![1526296083605.png](/static/assets/1526296083605.png)
...
![1526297276667](/static/assets/1526297276667.png)
...
首先，我们在data中定义变量，记录查询到的规格参数模板：
 ...
 ![1526297766476](/static/assets/1526297766476.png)

然后，我们通过watch监控goods.categories的变化，然后去查询规格：

  ![1526375545366](/static/assets/1526375545366.png)

查看是否查询到：

 ![1526297980403](/static/assets/1526297980403.png)
...
规格参数中的属性有一些需要我们特殊处理：
 ...
 ![1526298277201](/static/assets/1526298277201.png)
...
效果：
 ...
 ![1526302470344](/static/assets/1526302470344.png)
...
首先：我们在data中新建一个属性，保存特有的规格参数：
 ...
 ![1526306568822](/static/assets/1526306568822.png)
...
查看数据：
 ...
 ![1526306826026](/static/assets/1526306826026.png)
...
我们的目标效果是这样的：
 ...
 ![1526307835157](/static/assets/1526307835157.png)
...
![1526308151513](/static/assets/1526308151513.png)



测试下，勾选checkbox或填写文本会发生什么：

 ![1526308483766](/static/assets/1526308483766.png)

看下规格模板的值：

 ![1526308513342](/static/assets/1526308513342.png)
...
![1526309463115](/static/assets/1526309463115.png)
...
效果：
 ...
 ![](/static/assets/11.gif)



而删除文本框相对就比较简单了，只要在文本框末尾添加一个按钮，添加点击事件即可，代码：

 ![1526310720065](/static/assets/1526310720065.png)
...
![1526311110498](/static/assets/1526311110498.png)
...
![1526311330409](/static/assets/1526311330409.png)
...
结果：
 ...
 ![1526354069684](/static/assets/1526354069684.png)
...
结果：
 ...
 ![1526355132141](/static/assets/1526355132141.png)
...
结果：
 ...
 ![1526356312119](/static/assets/1526356312119.png)
...
查看生成的数据：
 ...
 ![1526363824808](/static/assets/1526363824808.png)
...
![1526364758744](/static/assets/1526364758744.png)
...
![1526365039421](/static/assets/1526365039421.png)
...
![1526366340741](/static/assets/1526366340741.png)

用法也非常简单，添加一个template，把其slot属性指定为expand即可：

![1526366667064](/static/assets/1526366667064.png)

效果：

![1526366997943](/static/assets/1526366997943.png)



接下来就是我们的图片上传组件：v-upload

![1526367719809](/static/assets/1526367719809.png)
...
![1526366187195](/static/assets/1526366187195.png)
...
![1526391630336](/static/assets/1526391630336.png)
