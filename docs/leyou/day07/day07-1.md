...
每次在C盘寻找hosts文件并修改是非常麻烦的，给大家推荐一个快捷修改host的工具，在课前资料中可以找到：
 ...
 ![1526014883706](/static/assets/1526014883706.png)

效果：

 ![1526015022365](/static/assets/1526015022365.png)
...
现在，ping一下域名试试是否畅通：
 ...
 ![1526015211298](/static/assets/1526015211298.png)
...
我们在本地安装一台nginx：
 ...
 ![1526016829605](/static/assets/1526016829605.png)

目录结构：

 ![1526188477802](/static/assets/1526188477802.png)
...
![1526017010289](/static/assets/1526017010289.png)
...
首先导入课前资料提供的sql：
 ...
 ![1525999677772](/static/assets/1525999677772.png)
...
![1525999250932](/static/assets/1525999250932.png)

商品分类之间是会有层级关系的，采用树结构去展示是最直观的方式。

一起来看页面，对应的是/pages/item/Category.vue：

 ![1526000313361](/static/assets/1526000313361.png)
...
![1526004282868](/static/assets/1526004282868.png)
...
这是因为，我们有一个全局的配置文件，对所有的请求路径进行了约定：
 ...
 ![1526005059829](/static/assets/1526005059829.png)

 ![1526005071153](/static/assets/1526005071153.png)

路径是localhost，并且默认加上了/api的前缀，这恰好与我们的网关设置匹配，我们只需要把地址改成网关的地址即可,因为我们使用了nginx反向代理，这里可以写域名：

 ![1526017217473](/static/assets/1526017217473.png)

再次查看页面，发现地址已经变成了正确的地址了：

 ![1526017265625](/static/assets/1526017265625.png)
...
在`ly-item-interface`中添加category实体类：
 ...
 ![1527483519579](/static/assets/1527483519579.png)
...
结构：
 ...
 ![1526006869782](/static/assets/1526006869782.png)
...
在刚才页面发起的请求中，我们就能得到绝大多数信息：
 ...
 ![1527473096007](/static/assets/1527473096007.png)
...
项目结构：
 ...
 ![1527483458604](/static/assets/1527483458604.png)
...
我们不经过网关，直接访问：
 ...
 ![1526009785484](/static/assets/1526009785484.png)

然后试试网关是否畅通：

  ![1526017422684](/static/assets/1526017422684.png)

一切OK！

然后刷新页面查看：

![1526017362418](/static/assets/1526017362418.png)
...
当浏览器发现发现的ajax请求是简单请求时，会在请求头中携带一个字段：`Origin`.
 ...
 ![1526019242125](/static/assets/1526019242125.png)
...
结构：
 ...
 ![1526021505774](/static/assets/1526021505774.png)
...
访问正常：
 ...
 ![1526021419016](/static/assets/1526021419016.png)

页面也OK了：

![1526021447335](/static/assets/1526021447335.png)
...
为了方便看到效果，我们新建一个MyBrand.vue（注意先停掉服务器），从0开始搭建。
 ...
 ![1526023142926](/static/assets/1526023142926.png)
...
![1526023276997](/static/assets/1526023276997.png)

打开服务器，再次查看页面：

![1526023471428](/static/assets/1526023471428.png)
...
![1526029445561](/static/assets/1526029445561.png)
...
![1526029907794](/static/assets/1526029907794.png)
...
![1526030236992](/static/assets/1526030236992.png)

然后在官方文档中找到按钮的用法：

![1526030329303](/static/assets/1526030329303.png)
...
![1526030431704](/static/assets/1526030431704.png)

#### 新增按钮

因为新增根某个品牌无关，是独立的，因此我们可以放到表格的外面：

 ![1526030663178](/static/assets/1526030663178.png)

效果：

![1526030540341](/static/assets/1526030540341.png)
...
![1526031720583](/static/assets/1526031720583.png)
...
![1526032177687](/static/assets/1526032177687.png)

发现输入框变的超级长！！！

这个时候，我们可以使用Vuetify提供的一个空间隔离工具：

![1526032321057](/static/assets/1526032321057.png)
...
![1526032398630](/static/assets/1526032398630.png)
...
![1526033167381](/static/assets/1526033167381.png)
...
![1526033500219](/static/assets/1526033500219.png)
...
- 响应结果：分页结果一般至少需要两个数据
  ...
  另外，这个PageResult以后可能在其它项目中也有需求，因此我们将其抽取到`ly-common`中，提高复用性：
   ...
   ![1526046620269](/static/assets/1526046620269.png)
...
完整结构：
 ...
 ![1527483582757](/static/assets/1527483582757.png)
...
通过浏览器访问试试：http://api.leyou.com/api/item/brand/page
 ...
 ![1526047708748](/static/assets/1526047708748.png)
...
而页面中分页信息应该是在pagination对象中，我们通过浏览器工具，查看pagination中有哪些属性：
 ...
 ![](/static/assets/1526042136135.png)
...
查看网络请求：
 ...
 ![1526049810351](/static/assets/1526049810351.png)

效果：

![1526049139244](/static/assets/1526049139244.png)
...
![1526049720200](/static/assets/1526049720200.png)
...
查看网络请求：
 ...
 ![1526050032436](/static/assets/1526050032436.png)

页面结果：

![1526050071442](/static/assets/1526050071442.png)
