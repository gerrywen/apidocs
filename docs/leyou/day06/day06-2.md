...
为了让接下来的功能比较清晰，我们先新建一个文件夹：src:
 ...
 ![1525868223969](/static/assets/1525868223969.png)

然后新建一个HTML文件，作为入口：index.html

 ![1525868284332](/static/assets/1525868284332.png)
...
样式：
 ...
 ![1525868623712](/static/assets/1525868623712.png)
...
接下来我们来实现登录组件，以前我们都是写在一个文件中，但是为了复用性，开发中都会把组件放如独立的JS文件中，我们新建一个login.js
 ...
 ![1525868736799](/static/assets/1525868736799.png)
...
新建单文件组件：register.js
 ...
 ![1525869269916](/static/assets/1525869269916.png)
...
效果：
 ...
 ![1525869621647](/static/assets/1525869621647.png)
...
使用npm安装：`npm install vue-router --save` 
 ...
 ![1525870170532](/static/assets/1525870170532.png)
...
![1525866284055](/static/assets/1525866284055.png)

官网给出的解释：

![1525866410437](/static/assets/1525866410437.png)
...
![1525873000269](/static/assets/1525873000269.png)

此时，我们注意下项目中文件夹下，会有一个package.json文件。（其实早就有了）

 ![1525873145475](/static/assets/1525873145475.png)
...
接下来，我们编写一个webpack的配置，来指定一些打包的配置项。配置文件的名称，默认就是webpack.config.js，我们放到hello-vue的根目录：
 ...
 ![1525873610812](/static/assets/1525873610812.png)
...
我们新建一个js，把index.html中的部分内容进行集中，然后在index.html中引用这个js不就OK了！
 ...
 ![1525874002350](/static/assets/1525874002350.png)
...
![1525875749502](/static/assets/1525875749502.png)

随后，查看dist目录：

 ![1525875792078](/static/assets/1525875792078.png)

尝试打开build.js，你根本看不懂：

![1525876060602](/static/assets/1525876060602.png)
...
然后运行：
 ...
 ![1525875932114](/static/assets/1525875932114.png)
...
我们来编写一段CSS代码，对index的样式做一些美化：
 ...
 ![1525877099220](/static/assets/1525877099220.png)
...
![1525877313725](/static/assets/1525877313725.png)

此时，在package.json中能看到新安装的：

 ![1525877634350](/static/assets/1525877634350.png)
...
再次输入打包指令：`npx webpack --config webpack.config.js`
 ...
 ![1525877746191](/static/assets/1525877746191.png)

效果：

 ![1525877882425](/static/assets/1525877882425.png)
...
我们可以把webpack的命令编入其中：
 ...
 ![1525878015255](/static/assets/1525878015255.png)

以后，如果要打包，就可以直接输入：`npm run build`即可。

- `npm run` ：执行npm脚本，后面跟的是脚本的名称`build`

![1525878133337](/static/assets/1525878133337.png)
...
2）将原来HTML中的引入js代码删除：
  ...
  ![1527390662284](/static/assets/1527390662284.png)

3）再次打包：`npm run build`

![1525879126478](/static/assets/1525879126478.png)

4）查看dist目录：

 ![1525879160040](/static/assets/1525879160040.png)
...
```
 ...
 ![1525912021845](/static/assets/1525912021845.png)

4）效果：

 ![1525912255757](/static/assets/1525912255757.png)
...
我们新建一个module：
 ...
 ![1525912928592](/static/assets/1525912928592.png)

打开终端并进入目录：

 ![1525913049617](/static/assets/1525913049617.png)

用vue-cli命令，快速搭建一个webpack的项目：`vue init webpack`

![1525913141066](/static/assets/1525913141066.png)

 ![1525913197139](/static/assets/1525913197139.png)

前面几项都走默认或yes

下面这些我们选no

 ![1525913230564](/static/assets/1525913230564.png)

最后，再选yes，使用 npm安装

 ![1525913263487](/static/assets/1525913263487.png)



![1525913307569](/static/assets/1525913307569.png)
...
安装好的项目结构：
 ...
 ![1525913435086](/static/assets/1525913435086.png)



入口文件：

![1525913687860](/static/assets/1525913687860.png)
...
![1525914072353](/static/assets/1525914072353.png)
...
![1525914618504](/static/assets/1525914618504.png)
...
我们执行`npm run dev` 或者 `npm start` 都可以启动项目：
 ...
 ![1525914808164](/static/assets/1525914808164.png)



页面：

![1525914871848](/static/assets/1525914871848.png)
...
后台项目相对复杂，为了有利于教学，我们不再从0搭建项目，而是直接使用课前资料中给大家准备好的源码：
 ...
 ![1525955154460](/static/assets/1525955154460.png)

我们解压缩，放到工作目录中：

 ![1525955615381](/static/assets/1525955615381.png)



然后在eclipse中导入新的工程：

 ![1525955644681](/static/assets/1525955644681.png)

选中我们的工程：

 ![1525955709334](/static/assets/1525955709334.png)



这正是一个用vue-cli构建的webpack工程，是不是与昨天的一样：

 ![1525955811416](/static/assets/1525955811416.png)

## 4.2.安装依赖

你应该注意到，这里并没有node_modules文件夹，方便给大家下发，已经把依赖都删除了。不过package.json中依然定义了我们所需的一切依赖：

 ![1525956016683](/static/assets/1525956016683.png)

我们只需要通过命令来安装所需依赖即可。打开终端，进入项目目录，输入：`npm install`

 ![1525957503521](/static/assets/1525957503521.png)
...
```
 ...
 ![1525957604219](/static/assets/1525957604219.png)

发现默认的端口是9001。访问：http://localhost:9001

会自动进行跳转：

![1525958950616](/static/assets/1525958950616.png)
...
![1525959769978](/static/assets/1525959769978.png)
...
![1525962755237](/static/assets/1525962755237.png)
...
![1525964023585](/static/assets/1525964023585.png)
...
![1525965105184](/static/assets/1525965105184.png)
...
- `v-navigation-drawer` ：导航抽屉，主要用于容纳应用程序中的页面的导航链接。 
   ...
   ![1525965560286](/static/assets/1525965560286.png)

- `v-toolbar `：工具栏通常是网站导航的主要途径。可以与导航抽屉一起很好地工作，动态选择是否打开导航抽屉，实现可伸缩的侧边栏。

  ![1525965585695](/static/assets/1525965585695.png)
