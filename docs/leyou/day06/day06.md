...
![1530555871804](/static/assets/1530555871804.png)

我们解压缩，放到工作目录中：

![1530367369490](/static/assets/1530367369490.png)



然后在Intellij idea中导入新的工程：

![1530367589197](/static/assets/1530367589197.png)

选中我们的工程：

 ![1530367781173](/static/assets/1530367781173.png)



这正是一个用vue-cli构建的webpack工程，是不是与昨天的一样：

 ![1530368191250](/static/assets/1530368191250.png)
...
![1530368695265](/static/assets/1530368695265.png)

我们只需要打开终端，进入项目目录，输入：`npm install`命令，即可安装这些依赖。

![1530374769782](/static/assets/1530374769782.png)

大概需要几分钟。

**如果安装过程出现以下问题**：

![1530374827792](/static/assets/1530374827792.png)
...
![1530374954209](/static/assets/1530374954209.png)

发现默认的端口是9001。访问：http://localhost:9001

会自动进行跳转：

![1525958950616](/static/assets/1530375152204.png)
...
![1525960652724](/static/assets/1525960652724.png)
...
![1530555978248](/static/assets/1530555978248.png)
...
![1525960312939](/static/assets/1525960312939.png)



我们重点关注`UI components`即可，里面有大量的UI组件，我们要用的时候再查看，不用现在学习，先看下有什么：

 ![1525961862771](/static/assets/1525961862771.png)

 ![1525961875288](/static/assets/1525961875288.png)
...
首先是目录结构图：![1525962755237](/static/assets/1525962755237.png)
...
![1530380040278](/static/assets/1530380040278.png)

一个典型的三块布局。包含左，上，中三部分：

 ![1525965779366](/static/assets/1525965779366.png)
...
![1530556073565](/static/assets/1530556073565.png)

解压，运行exe文件，效果：

![1530382550630](/static/assets/1530382550630.png)
...
![1530382601757](/static/assets/1530382601757.png)

OK！

通过域名访问：

![1530383586463](/static/assets/1530383586463.png)

原因：我们配置了项目访问的路径，虽然manage.leyou.com映射的ip也是127.0.0.1，但是webpack会验证host是否符合配置。

![1530383612716](/static/assets/1530383612716.png)

在webpack.dev.conf.js中取消host验证：

![1530383927461](/static/assets/1530383927461.png)

重新执行`npm run dev`，刷新浏览器：

![1530384150852](/static/assets/1530384150852.png)
...
### 4.4.1.什么是Nginx
 ...
 ![1526187409033](/static/assets/1526187409033.png)
...
![1526016663674](/static/assets/1526016663674.png)
...
![img](/static/assets/0C36B84E.gif) 

我们在本地安装一台nginx：

![1530556268445](/static/assets/1530556268445.png)

解压后，目录结构：

![1530384792790](/static/assets/1530384792790.png)
...
示例：
 ...
 ![1526188831504](/static/assets/1526188831504.png)
...
![1530385404783](/static/assets/1530385404783.png)
...
![1530385593052](/static/assets/1530385593052.png)

现在实现了域名访问网站了，中间的流程是怎样的呢？

![1526189945180](/static/assets/1526189945180.png)
...
![1525999005260](/static/assets/1525999005260.png)
...
![1530556389224](/static/assets/1530556389224.png)

我们先看商品分类表：

 ![1525999774439](/static/assets/1525999774439.png)
...
![1530413709515](/static/assets/1530413709515.png)

商品分类之间是会有层级关系的，采用树结构去展示是最直观的方式。

一起来看页面，对应的是/pages/item/Category.vue：

 ![1530386186299](/static/assets/1530386186299.png)
...
![1530427294644](/static/assets/1530427294644.png)
...
![1530427514123](/static/assets/1530427514123.png)
...
在`ly-item-interface`中添加category实体类：
 ...
 ![1530444682670](/static/assets/1530444682670.png)
...
![1530445885707](/static/assets/1530445885707.png)
...
添加Controller：
 ...
 ![1530450599897](/static/assets/1530450599897.png)
...
一般service层我们会定义接口和实现类，不过这里我们就偷懒一下，直接写实现类了：
 ...
 ![1530450744567](/static/assets/1530450744567.png)
...
![1530455133230](/static/assets/1530455133230.png)

然后试试网关是否畅通：http://api.leyou.com/api/item/category/list

![1530455291468](/static/assets/1530455291468.png)

一切OK！

然后刷新后台管理页面查看：

![1530455437899](/static/assets/1530455437899.png)
...
![1530460311064](/static/assets/1530460311064.png)
...
结构：
 ...
 ![1530462650711](/static/assets/1530462650711.png)



重启测试，访问正常：

![1530463010927](/static/assets/1530463010927.png)
...
![1526021968036](/static/assets/1526021968036.png)
...
为了方便看到效果，我们新建一个MyBrand.vue（注意先停掉服务器），从0开始搭建。
 ...
 ![1530464178834](/static/assets/1530464178834.png)
...
![1530464255544](/static/assets/1530464255544.png)

打开服务器，再次查看页面：

![1530464304721](/static/assets/1530464304721.png)
...
![1526023540226](/static/assets/1526023540226.png)
...
![1526023837773](/static/assets/1526023837773.png)
...
- loading：boolean类型，true：代表数据正在加载，会有进度条。false：数据加载完毕。
  ...
  ![1526029254159](/static/assets/1526029254159.png)
...
![1530518876942](/static/assets/1530518876942.png)
...
![1530523252532](/static/assets/1530523252532.png)
...
![1530523838357](/static/assets/1530523838357.png)
...
![1530524238344](/static/assets/1530524238344.png)

因为新增跟某个品牌无关，是独立的，因此我们可以放到表格的外面。

![1530527129881](/static/assets/1530527129881.png)

效果：

![1530527160208](/static/assets/1530527160208.png)
...
![1526031159242](/static/assets/1526031159242.png)
...
![1530532504861](/static/assets/1530532504861.png)
...
![1526031897445](/static/assets/1526031897445.png)
...
![1530533261856](/static/assets/1530533261856.png)

发现输入框超级长！！！

这个时候，我们可以使用Vuetify提供的一个空间隔离工具：

![1530533442878](/static/assets/1530533442878.png)
...
![1530534269196](/static/assets/1530534269196.png)
...
查看textfiled的文档，发现：
 ...
 ![1526033007616](/static/assets/1526033007616.png)
...
![1530534311458](/static/assets/1530534311458.png)
...
![1526033439890](/static/assets/1526033439890.png)
...
![1530534423194](/static/assets/1530534423194.png)
...
### 7.2.2.实体类
 ...
 ![1530541070271](/static/assets/1530541070271.png)
...
### 7.2.3.mapper
 ...
 ![1530541222679](/static/assets/1530541222679.png)
...
另外，这个PageResult以后可能在其它项目中也有需求，因此我们将其抽取到`leyou-common`中，提高复用性：
 ...
 ![1530543778541](/static/assets/1530543778541.png)
...
接下来，我们编写Controller
 ...
 ![1530549253999](/static/assets/1530549253999.png)
...
### 7.2.5.Service
 ...
 ![1530549286718](/static/assets/1530549286718.png)
...
![1530549095150](/static/assets/1530549095150.png)
...
Vue官方推荐的ajax请求框架叫做：axios，看下demo：
 ...
 ![1526033988251](/static/assets/1526033988251.png)
...
而在我们的项目中，已经引入了axios，并且进行了简单的封装，在src下的http.js中：
 ...
 ![1526034150067](/static/assets/1526034150067.png)
...
- http.js中导入了config的配置，还记得吗？
   ...
   ![1526041205846](/static/assets/1526041205846.png)
...
我们在组件`MyBrand.vue`的getDataFromServer方法，通过$http发起get请求，测试查询品牌的接口，看是否能获取到数据：
 ...
 ![1526048221750](/static/assets/1526048079191.png)

网络监视：

 ![1526048143014](/static/assets/1526048143014.png)

resp到底都有那些数据，查看控制台结果：

![1526048275064](/static/assets/1526048275064.png)
...
![1530553414937](/static/assets/1530553414937.png)
...
![1530554422695](/static/assets/1530554422695.png)

效果：

![1530554460215](/static/assets/1530554460215.png)
...
![1526049643506](/static/assets/1526049643506.png)

成功实现分页功能：

![1526049720200](/static/assets/22.gif)
...
分页实现了，过滤也很好实现了。过滤字段对应的是search属性，我们只要监视这个属性即可:
 ...
 ![1526049939985](/static/assets/1526049939985.png)
...
![1530555740595](/static/assets/1530555740595.png)
