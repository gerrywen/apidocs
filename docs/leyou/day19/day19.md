...
然后在工程内导入：
 ...
 ![1527849592739](/static/assets/1527849592739.png)

然后导入module：

 ![1527849713858](/static/assets/1527849713858.png)

选择导入module：

 ![1527849755740](/static/assets/1527849755740.png)

选择目录中的 `ly-order`：

 ![1527988253596](/static/assets/1527988253596.png)

打开父工程leyou的pom文件，添加`ly-order`模块：

![1527988384844](/static/assets/1527988384844.png)
...
看官方的说明：
 ...
 ![1528724925709](/static/assets/1528724925709.png)
...
![1534050474425](/static/assets/1534050474425.png)

点击order-controller，查看接口信息：

![1534050501639](/static/assets/1534050501639.png)

点击任意一个接口，即可看到详细信息：

![1534050571547](/static/assets/1534050571547.png)
...
![1528726383029](/static/assets/1528726383029.png)
...
![1534050960735](/static/assets/1534050960735.png)

结果：

![1534056625226](/static/assets/1534056625226.png)

下单需要登录，通过登录生成token：

![1534056963545](/static/assets/1534056963545.png)

把token的值手动加入到浏览器的cookie中：

![1534057111628](/static/assets/1534057111628.png)

![1534057197865](/static/assets/1534057197865.png)
...
这里的订单id是通过一个工具类生成的：
 ...
 ![1534057752285](/static/assets/1534057752285.png)
...
雪花算法会生成一个64位的二进制数据，为一个Long型。(转换成字符串后长度最多19位) ，其基本结构：
 ...
 ![1528729105237](/static/assets/1528729105237.png)
...
![1534057869509](/static/assets/1534057869509.png)
...
![1534058725566](/static/assets/1534058725566.png)

结果：

![1534058696076](/static/assets/1534058696076.png)
...
![1534059150417](/static/assets/1534059150417.png)

结果：

![1534059488506](/static/assets/1534059488506.png)

数据库中也发生了改变：

![1534059550338](/static/assets/1534059550338.png)
...
![1534059762431](/static/assets/1534059762431.png)

结果：

![1534059802562](/static/assets/1534059802562.png)
...
![1534059974834](/static/assets/1534059974834.png)

结果：

![1534060051812](/static/assets/1534060051812.png)
...
跟支付相关的其它几个类：
 ...
 ![1528796883071](/static/assets/1528796883071.png)
...
![1534060875467](/static/assets/1534060875467.png)

结果：

![1534061834503](/static/assets/1534061834503.png)
...
![1534061965270](/static/assets/1534061965270.png)

进入，并输入刚刚生成的地址：

![1534062028046](/static/assets/1534062028046.png)

#### 1.3.6.3.已付款

扫码支付，然后再次查询：

![1534062115599](/static/assets/1534062115599.png)
...
![1527990452791](/static/assets/1527990452791.png)

当点击结算，我们应该跳转到订单结算页，即：`getOrderInfo.html`

 ![1534062458952](/static/assets/1534062458952.png)

查看购物车的`结算`按钮：

![1534063127883](/static/assets/1534063127883.png)

可以看到，地址是正确的。但是只有登录用户才可以去结算付款，因此我们不能直接跳转，而是在跳转前校验用户的登录状态，如果发现是未登录，应该重定向到登录页！

我们给这个按钮绑定点击事件：

![1534063368728](/static/assets/1534063368728.png)
...
![1534068627040](/static/assets/1534068627040.png)
...
![1528011713709](/static/assets/1528011713709.png)

这里的收货人信息肯定是当前登录用户的收货地址。所以需要根据当前登录用户去查询，目前我们在页面是写的假数据：

![1534070259673](/static/assets/1534070259673.png)
...
![1528012065388](/static/assets/1528012065388.png)

所以我们可以在Vue实例中定义一个属性来记录支付方式：

![1534070467947](/static/assets/1534070467947.png)

然后在页面渲染时与这个变量关联：

![1534070743780](/static/assets/1534070743780.png)
...
![1528012881735](/static/assets/1528012881735.png)
...
![1534071010391](/static/assets/1534071010391.png)

然后在`created`钩子函数中获取购物车数据，保存到本地属性，要注意的是，我们应该在获取数据前校验用户登录状态，如果发现未登录，则直接重定向到登录页：

![1534071493245](/static/assets/1534071493245.png)



然后重新加载页面，查看控制台：

![1534071647717](/static/assets/1534071647717.png)
...
![1534071794146](/static/assets/1534071794146.png)
...
![1534072483208](/static/assets/1534072483208.png)
...
![1534072753146](/static/assets/1534072753146.png)
...
![1534073678931](/static/assets/1534073678931.png)

效果：

![1534073704731](/static/assets/1534073704731.png)
...
![1534074122199](/static/assets/1534074122199.png)
...
- 订单详情
  ...
  ![1534074293296](/static/assets/1534074293296.png)
...
![1534074374101](/static/assets/1534074374101.png)
...
在页面点击提交测试：
 ...
 ![1528340102503](/static/assets/1528340102503.png)

成功生成订单！

然后看页面跳转：

 ![1528340136603](/static/assets/1528340136603.png)
...
因此，我们重写axios对响应的处理回调函数：
 ...
 ![1528340413139](/static/assets/1528340413139.png)
...
![1527848350188](/static/assets/1527848350188.png)

我们选择开发文档，而后进入选择页面：

![1527848358128](/static/assets/1527848358128.png)

选择扫码支付：

![1527848368179](/static/assets/1527848368179.png)
...
![2wa23131](/static/assets/chapter6_5_1.png)
...
后台已经定义好生成付款地址的接口。
 ...
 ![1528362159620](/static/assets/1528362159620.png)

刷新页面查看：

 ![1528362220886](/static/assets/1528362220886.png)
...
![1534313526721](/static/assets/1534313526721.png)

我们把课这个js脚本引入到项目中：

 ![1528362348399](/static/assets/1528362348399.png)

官方使用案例：

![1534313925398](/static/assets/1534313925398.png)

然后在页面引用：

 ![1528362377494](/static/assets/1528362377494.png)



页面定义一个div，用于展示二维码：

 ![1528362023061](/static/assets/1528362023061.png)

然后获取到付款链接后，根据链接生成二维码：

 ![1528362420151](/static/assets/1528362420151.png)
...
刷新页面，查看效果：
 ...
 ![1528362464276](/static/assets/1528362464276.png)
...
![1528376883924](/static/assets/1528376883924.png)
