...
![1532178218793](/static/assets/1532178218793.png)

![1532178276070](/static/assets/1532178276070.png)
...
![1532180648745](/static/assets/1532180648745.png)
...
再来看看页面中有什么数据：
 ...
 ![1526607712207](/static/assets/1526607712207.png) 
...
另外，页面还有过滤条件：
 ...
 ![1526608095471](/static/assets/1526608095471.png)
...
![1532213731039](/static/assets/1532213731039.png)
...
第一步：服务的提供方在`leyou-item-interface`中提供API接口，并编写接口声明：
 ...
 ![1526613268722](/static/assets/1526613268722.png)
...
项目结构：
 ...
 ![1532215914558](/static/assets/1532215914558.png)

 ![1532218231760](/static/assets/1532218231760.png)
...
在接口上按快捷键：`Ctrl + Shift + T`
 ...
 ![1532216103709](/static/assets/1532216103709.png)

 ![1532216169168](/static/assets/1532216169168.png)
...
![1532216884221](/static/assets/1532216884221.png)
...
![1532217819818](/static/assets/1532217819818.png)
...
![1532228358310](/static/assets/1532228358310.png)
...
![1526629923970](/static/assets/1526629923970.png)

当我们输入任何文本，点击搜索，就会跳转到搜索页`search.html`了：

并且将搜索关键字以请求参数携带过来：

![1532229236516](/static/assets/1532229236516.png)
...
![1532233280898](/static/assets/1532233280898.png)

并添加网关映射：

![1532233247824](/static/assets/1532233247824.png)



刷新页面试试：

![1532233086523](/static/assets/1532233086523.png)
...
![1532237344249](/static/assets/1532237344249.png)

![1532237401249](/static/assets/1532237401249.png)
...
![1532237986819](/static/assets/1532237986819.png)
...
![1532239032197](/static/assets/1532239032197.png)

在`loadData`的异步查询中，将结果赋值给`goodsList`：

![1532239117076](/static/assets/1532239117076.png)
...
![1532238893722](/static/assets/1532238893722.png)

可以看到，`div`中有一个无序列表`ul`，内部的每一个`li`就是一个商品spu了。

我们删除多余的，只保留一个`li`，然后利用vue的循环来展示搜索到的结果：

![1532239244410](/static/assets/1532239244410.png)
...
我们先来实现sku的选择，才能去展示不同sku的数据。
 ...
 ![1526654252710](/static/assets/1526654252710.png)
...
![1532240220800](/static/assets/1532240220800.png)

我们在查询成功的回调函数中，对goods进行遍历，把skus转化成对象，并添加一个selected属性保存被选中的sku：

![1532240609206](/static/assets/1532240609206.png)

![1532240586769](/static/assets/1532240586769.png)
...
![1532240706261](/static/assets/1532240706261.png)
...
![1526656197524](/static/assets/1526656197524.png)



刷新页面：

 ![1526656243166](/static/assets/1526656243166.png)
...
![1532242831006](/static/assets/1532242831006.png)

结果报错：

![1532242950035](/static/assets/1532242950035.png)

为啥？

因为在Vue范围内使用任何变量，都会默认去Vue实例中寻找，我们使用ly，但是Vue实例中没有这个变量。所以解决办法就是把ly记录到Vue实例：

![1532242983324](/static/assets/1532242983324.png)

然后刷新页面：

![1532243052100](/static/assets/1532243052100.png)
...
![1526656959487](/static/assets/1526656959487.png)
...
![1532243182104](/static/assets/1532243182104.png)

这段代码稍微改造一下，即可：

![1532243275078](/static/assets/1532243275078.png)

也就是说，我们先把selected属性初始化完毕，然后才把整个对象赋值给goodsList，这样，goodsList已初始化时就有selected属性，以后就会被正常监控了。

 ![](/static/assets/skus.gif)
...
![1532243978471](/static/assets/1532243978471.png)
...
在我们返回的PageResult对象中，其实是有totalPage字段的：
  ...
  ![1526695144476](/static/assets/1526695144476.png)

我们在返回时，把这个值填上：

 ![1526695592422](/static/assets/1526695592422.png)

页面测试一下：

![1532244453375](/static/assets/1532244453375.png)
...
![1532246481241](/static/assets/1532246481241.png)
...
![1526698842013](/static/assets/1526698842013.png)
...
![1532248549662](/static/assets/1532248549662.png)
...
在页面商品列表的顶部，也有一个分页条：
 ...
 ![1526716212704](/static/assets/1526716212704.png)

我们把这一部分，也加上点击事件：

![1532248435097](/static/assets/1532248435097.png)
...
在搜索商品列表的顶部，有这么一部分内容：
 ...
 ![1526716565293](/static/assets/1526716565293.png)
...
因此，我们首先在`search`中记录这两个信息，因为created钩子函数会对search进行覆盖，因此我们在钩子函数中对这两个信息进行初始化即可：
 ...
 ![1526717586493](/static/assets/1526717586493.png)
...
可以看到，页面请求参数中已经有了排序字段了：
 ...
 ![1526718252315](/static/assets/1526718252315.png)
...
现在，我们的请求参数对象`SearchRequest`中，只有page、key两个字段。需要进行扩展：
 ...
 ![1526718448918](/static/assets/1526718448918.png)



然后在搜索业务逻辑中，添加排序条件：

![1526718637618](/static/assets/1526718637618.png)
...
![1526719415219](/static/assets/1526719415219.png)
